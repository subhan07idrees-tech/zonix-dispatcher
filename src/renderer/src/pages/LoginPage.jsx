            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="zonix-input w-full font-mono pr-10"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-zonix-text-dim hover:text-zonix-text transition-colors"
                >
